...
--
-- Host: 127.0.0.1
-- Generation Time: May 13, 2022 at 11:50 PM
...
-- Database: `lab2_db`
--
CREATE DATABASE IF NOT EXISTS `lab2_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `lab2_db`;
...
CREATE TABLE `complaints` (
  ...
  `complaint_status` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
ALTER TABLE `agents`
  ADD CONSTRAINT `agents_ibfk_1` FOREIGN KEY (`agent_id`) REFERENCES `user_login_signup` (`id`);
...
--
ALTER TABLE `employee`
  ADD CONSTRAINT `employee_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `complaints` (`complaint_id`);
COMMIT;
